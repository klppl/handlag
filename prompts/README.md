...
| Prompt | Description |
| :--- | :--- |
| [Root Cause Bug Investigator](bug-investigator.md) | Systematically diagnose runtime bugs, stack traces, and unexplained failures by finding root causes, minimal fixes, and regression tests. |
| [Senior Production Code Review](code-review.md) | Perform a production-grade code review covering maintainability, error handling, performance, edge cases, and severity-classified feedback. |
...
| [Simplified Technical English Rewriter](ste-rewriter.md) | Rewrite verbose, sloppy, or convoluted text into concise, high-clarity Simplified Technical English (ASD-STE100) with zero AI fluff and strict factual fidelity. |
